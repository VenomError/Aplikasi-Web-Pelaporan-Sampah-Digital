    ...
    <body>
        ...
        <div class="main-wrapper">
            ...
            <div class="header">
                ...
                <ul class="nav user-menu">
                            ...
                            <form class="dropdown" action="#">
                                ...
                                >
                                    ...
                                    <div class="search-addon">
                                        <span><i class="feather-14" data-feather="x-circle"></i></span>
                                    </div>
                                </div>
                                <div class="dropdown-menu search-dropdown" aria-labelledby="dropdownMenuClickable">
                                    <div class="search-info">
                                        <h6><span><i class="feather-16" data-feather="search"></i></span>Recent Searches
                                        </h6>
                                    ...
                                    <div class="search-info">
                                        <h6><span><i class="feather-16" data-feather="help-circle"></i></span>Help</h6>
                                        <p>How to Change Product Volume from 0 to 200 on Inventory management</p>
                                        <p>Change Product Name</p>
                                    </div>
                                    <div class="search-info">
                                        <h6><span><i class="feather-16" data-feather="user"></i></span>Customers</h6>
                                        <ul class="customers">
                                            <li>
                                                <a href="javascript:void(0);">Aron Varu<img class="img-fluid"
                                                        src="assets/img/profiles/avator1.jpg" alt=""
                                                    ></a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);">Jonita<img class="img-fluid"
                                                        src="assets/img/profiles/avatar-01.jpg" alt=""
                                                    ></a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);">Aaron<img class="img-fluid"
                    ...
                    <li class="nav-item dropdown has-arrow main-drop select-store-dropdown">
                        <a class="dropdown-toggle nav-link select-store" data-bs-toggle="dropdown"
                            href="javascript:void(0);"
                        >
                            <span class="user-info">
                                <span class="user-letter">
                                    <img class="img-fluid" src="assets/img/store/store-01.png" alt="Store Logo">
                                </span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="javascript:void(0);">
                                <img class="img-fluid" src="assets/img/store/store-01.png" alt="Store Logo"> Grocery
                                Alpha
                            </a>
                            <a class="dropdown-item" href="javascript:void(0);">
                                <img class="img-fluid" src="assets/img/store/store-02.png" alt="Store Logo"> Grocery
                                Apex
                            </a>
                            <a class="dropdown-item" href="javascript:void(0);">
                                <img class="img-fluid" src="assets/img/store/store-03.png" alt="Store Logo"> Grocery
                                Bevy
                            </a>
                            <a class="dropdown-item" href="javascript:void(0);">
                                <img class="img-fluid" src="assets/img/store/store-04.png" alt="Store Logo"> Grocery
                                Eden
                            </a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown has-arrow flag-nav nav-item-box">
                        <a
                            ...
                            role="button"
                        >
                            <img class="img-fluid" src="assets/img/flags/us.png" alt="Language">
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <li class="nav-item dropdown nav-item-box">
                        <a class="dropdown-toggle nav-link" data-bs-toggle="dropdown" href="javascript:void(0);">
                                                ...
                                                <div class="media-body flex-grow-1">
                                                    <p class="noti-details"><span class="noti-title">Misty
                                                        ...
                                                        added <span class="noti-title">Domenic Houston</span> and <span
                                                            class="noti-title"
                                                        >Claire Mapes</span> to project <span class="noti-title">Doctor
                    ...
                    <li class="nav-item dropdown has-arrow main-drop">
                        ...
                        >
                            <span class="user-info">
                                <span class="user-letter">
                                    <img class="img-fluid" src="assets/img/profiles/avator1.jpg" alt="">
                                </span>
                                <span class="user-detail">
                    ...
                    <div class="sidebar-menu" id="sidebar-menu">
                        <ul>
                            <li class="submenu-open">
                                ...
                                <ul>
                                    <li class="submenu">
                                        <a class="subdrop active" href="javascript:void(0);"><i
                            ...
                            <li class="submenu-open">
                                ...
                                <ul>
                                    ...
                                    <li><a href="sub-categories.html"><i data-feather="speaker"></i><span>Sub
                                                Category</span></a></li>
                                    <li><a href="brand-list.html"><i data-feather="tag"></i><span>Brands</span></a>
                                    </li>
                            ...
                            <li class="submenu-open">
                                ...
                                <ul>
                                    ...
                                    <li><a href="store-list.html"><i data-feather="home"></i><span>Stores</span></a>
                                    </li>
                            ...
                            <li class="submenu-open">
                                ...
                                <ul>
                                    ...
                                    <li><a href="shift.html"><i data-feather="shuffle"></i><span>Shifts</span></a>
                                    </li>
                                    <li class="submenu">
                                        <a href="javascript:void(0);"><i
                            ...
                            <li class="submenu-open">
                                ...
                                <ul>
                                    <li><a href="users.html"><i data-feather="user-check"></i><span>Users</span></a>
                                    </li>
                            ...
                            <li class="submenu-open">
                                ...
                                <ul>
                                    <li><a href="profile.html"><i data-feather="user"></i><span>Profile</span></a>
                                    </li>
                                    <li class="submenu">
                                        <a href="javascript:void(0);"><i
                                    ...
                                    <li class="submenu">
                                        <a href="javascript:void(0);"><i
                                                data-feather="map"></i><span>Places</span><span
                                                class="menu-arrow"></span></a>
                                        <ul>
                            ...
                            <li class="submenu-open">
                                ...
                                <ul>
                                    ...
                                    <li class="submenu">
                                        <a href="javascript:void(0);">
                                            <i data-feather="edit"></i><span>Forms</span><span
                                                class="menu-arrow"></span>
                                        </a>
                                        <ul>
            ...
            <div class="sidebar collapsed-sidebar" id="collapsed-sidebar">
                <div class="sidebar-inner slimscroll">
                    <div class="sidebar-menu sidebar-menu-three" id="sidebar-menu-2">
                        <aside class="ui-aside" id="aside">
                        ...
                        <div class="tab-content tab-content-four pt-2">
                            <ul class="tab-pane active" id="home" aria-labelledby="home-tab">
                                <li class="submenu">
                                    <a class="active" href="javascript:void(0);"><span>Dashboard</span> <span
                                            class="menu-arrow"
                                        ></span></a>
                                    <ul>
                                        <li><a class="active" href="index.html">Admin Dashboard</a></li>
                            ...
                            <ul class="tab-pane" id="employee" aria-labelledby="set-tab2">
                                ...
                                <li class="submenu">
                                    <a href="payroll-list.html"><span>Payroll</span><span
                                            class="menu-arrow"></span></a>
                                    <ul>
                                        <li><a href="payroll-list.html">Employee Salary</a></li>
                                        <li><a href="payslip.html">Payslip</a></li>
            ...
            <div class="sidebar horizontal-sidebar">
                <div class="sidebar-menu" id="sidebar-menu-3">
                    <ul class="nav">
                        <li class="submenu">
                            <a class="active subdrop" href="index.html"><i data-feather="grid"></i><span> Main
                                    Menu</span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li class="submenu">
                                    <a class="active subdrop" href="javascript:void(0);"><span>Dashboard</span>
                ...
                <ul class="sticky-sidebar">
                    <li class="sidebar-icons">
                        <a
                            ...
                            href="#"
                        >
                            <i class="feather-five" data-feather="settings"></i>
                        </a>
                    </li>
                </ul>
            </div>
