...
new class extends Component {
    ...
    public function reports()
    {
        ...
        $query->where('status', ReportStatus::COMPLETED);
...
<div>
    <div class="row justify-content-center">
        ...
        <x-widget.dash-count
            class="col-lg-6"
            :title="ReportStatus::PROCESSING->value"
            :count="$this->reportCountByStatus(ReportStatus::PROCESSING)"
            :color="ReportStatus::PROCESSING->color()"
            :icon="ReportStatus::PROCESSING->icon()"
        />
    </div>
